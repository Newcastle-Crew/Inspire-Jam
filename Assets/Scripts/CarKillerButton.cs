...
public class CarKillerButton : MonoBehaviour, SUPERCharacter.IInteractable, InteractSound {
    public string interactionName { get => "Release"; }
    public float grabTime { get => 6f; }

    public CarAccelerator controlling;
    ...
    public bool Interact() {
        controlling.rb.constraints = RigidbodyConstraints.None;
